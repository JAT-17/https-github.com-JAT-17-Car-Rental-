...
namespace Car_Rental_Assignment_Second_Assignment
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            CartItem ItemSelected2 = new CartItem("Nissan", Convert.ToInt32(ddlNissan.SelectedValue), 7500M, Convert.ToString(fromdatepicker2.Text), Convert.ToString(todatepicker2.Text));
