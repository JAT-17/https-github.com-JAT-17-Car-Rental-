<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="Car_Rental_Assignment_Second_Assignment.Account.OpenAuthProviders" %>
